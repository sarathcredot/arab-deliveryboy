...
const WarrantyRemarkPopup = ({ remarks, setRemarks, submit, isOpen, toggle }: any) => {
  ...
  return (
    ...
    >
      <ModalBody className="p-4 py-5 p-md-5">
        <h5>Please enter remarks for the warranty status change.</h5>
        <div
...
export default WarrantyRemarkPopup;
